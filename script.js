...
generate.onclick = function(){
    message.textContent = "Hi, my name is " + names[Math.floor(Math.random() * names.length)] + " and I come from " + country_list[Math.floor(Math.random() * country_list.length)] + "! In my free time I enjoy " +  interests[Math.floor(Math.random() * interests.length)].toLowerCase() + ".";
}